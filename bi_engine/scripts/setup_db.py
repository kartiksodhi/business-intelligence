...
KNOWN_SOURCE_IDS = {
    "MCA OGD": "mca_ogd",
    "MCA charge register": "mca_charge_register",
    ...
    "IBBI": "ibbi",
    "High Court commercial division": "high_court_commercial_division",
    "Supreme Court cause lists": "supreme_court_cause_lists",
    "Labour court orders": "labour_court_orders",
    "GST portal": "gst_portal",
    "DGFT": "dgft",
    "SEBI bulk/block deals": "sebi_bulk_block_deals",
    "SEBI enforcement orders": "sebi_enforcement_orders",
    "CERSAI": "cersai",
    "RBI wilful defaulter list": "rbi_wilful_defaulter_list",
    "CCI filings": "cci_filings",
    "State VAT/commercial tax portals": "state_vat_commercial_tax_portals",
    "GeM": "gem",
    "CPPP": "cppp",
    "EPFO": "epfo",
    "ESIC": "esic",
    "Naukri.com": "naukri",
    "Indeed India / Foundit": "indeed_foundit",
    "Company career pages": "company_career_pages",
    "Glassdoor India": "glassdoor_india",
    "LinkedIn": "linkedin_indirect",
    "Udyam registration portal": "udyam_registration_portal",
    "RERA": "rera",
    "MOEF environment clearance portal": "moef_environment_clearance_portal",
    "Pollution control boards": "pollution_control_boards",
    "RBI NBFC/bank notifications": "rbi_nbfc_bank_notifications",
}
